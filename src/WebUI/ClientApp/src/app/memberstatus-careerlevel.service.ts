...
import { ICareerLevelLookupDto, IMemberStatusLookupDto, MemberStatusClient, CareerLevelClient } from "src/app/membermanager-api";
...
export class MemberstatusCareerlevelService {
  ...
  constructor(protected statusApi: MemberStatusClient, protected careerLevelClient: CareerLevelClient) {}

  isLoaded(): boolean {
    return this.memberStatus !== null && this.careerLevels !== null;
  }

  async doLoad(forceRefresh: boolean = false): Promise<[IMemberStatusLookupDto[], ICareerLevelLookupDto[]]> {
