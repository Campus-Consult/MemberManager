...
import { CreateMemberStatusCommand, ICreateMemberStatusCommand, MemberStatusClient } from "../../../../membermanager-api";
...
export class MemberStatusCreateComponent {
  ...
  constructor(public dialogRef: MatDialogRef<MemberStatusCreateComponent>,private memberStatusClient: MemberStatusClient) {
    this.fromData = {name:''};
  }
  ...
  createMemberStatus(){
    ...
    this.errmsg = '';
    this.memberStatusClient.create(command).subscribe((numberStatus)=>{
