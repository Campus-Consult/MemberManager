...
import { MemberStatusCreateDialogComponent } from './components/member-status-create-dialog/member-status-create-dialog.component';
...
@NgModule({
  ...
  declarations: [
    ...
    MemberStatusCreateDialogComponent,
  ],
  exports: [
    MemberStatusComponent,
  ]
